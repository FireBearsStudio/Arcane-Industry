...
public class ItemArcaneMultitool extends ItemPickaxe {

	public ItemArcaneMultitool(String unlocalizedName, ToolMaterial material) {
		super(material);
	...
	protected boolean useHoe(ItemStack stack, EntityPlayer player, World worldIn, BlockPos target, IBlockState newState) {
		worldIn.playSoundEffect(target.getX() + 0.5F, target.getY() + 0.5F, target.getZ() + 0.5F, newState.getBlock().stepSound.getStepSound(),
